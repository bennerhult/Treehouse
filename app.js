                                        ...
                                        if (goalTexts.length == currentAchievement.goals.length) {
                                            ...
                                            goalTexts.forEach(function(goalText, index) {
                                                ...
                                                if (index == goalTexts.length - 1) {
                                                    ...
                                                    achievementDesc += '<a href="https://twitter.com/?text=' + currentAchievement.title + '&share' + '?url=http://treehouse.io/achievement?achievementId=' + currentAchievement._id + '&userId=' + currentAchievement.createdBy + '" class="twitter-share-button">Tweet</a>'
