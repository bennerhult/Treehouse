                                        ...
                                        if (goalTexts.length == currentAchievement.goals.length) {
                                            ...
                                            goalTexts.forEach(function(goalText, index) {
                                                ...
                                                if (index == goalTexts.length - 1) {
                                                    ...
                                                    achievementDesc += '<a href="https://twitter.com/share?url=http://treehouse.io&text=' + currentAchievement.title + '" class="twitter-share-button">Tweet</a>'
                                                    achievementDesc += '<script>setTimeout(function() {!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?"http":"https";if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document, "script", "twitter-wjs");}, 5000);</script>'
