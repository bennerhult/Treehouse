...
function writeAchievementPage(response, currentUserId, currentAchievement, publicView) {
    ...
    response.write("<meta property='og:url' content='www.treehouse.io/achievement?achievementId=" + currentAchievement._id +"&userId=" + currentUserId + "'/>");    //The canonical, permanent URL of the page representing the entity. When you use Open Graph tags, the Like button posts a link to the og:url instead of the URL in the Like button code.
