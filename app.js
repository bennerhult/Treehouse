                                        ...
                                        if (goalTexts.length == currentAchievement.goals.length) {
                                            ...
                                            goalTexts.forEach(function(goalText, index) {
                                                ...
                                                if (index == goalTexts.length - 1) {
                                                    ...
                                                    achievementDesc += '<div class="publicWrap"><div id="fbLike" style="overflow:visible;"><div class="fb-like" data-href="http://treehouse.io/achievement?achievementId=' + currentAchievement._id + '&userId=' + userId + '" data-width="150px"font="segoe ui" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div></div>'
