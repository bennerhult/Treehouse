    ...
    function registerHandlers() {
        app.post('/api/achievements/createAchievement', function (request, response) {
            cleanUpGoalList( request.body.goalList, function(goalList) {
                achievement.createAchievement2(request.session.currentUser._id, request.body.achievementTitle, request.body.achievementDescription, request.body.achievementImage, goalList, function() {
