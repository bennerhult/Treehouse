...
function topAppPagePart() {
    var text = '<!DOCTYPE html>' + nl +
        ...
        tab + '<link rel="apple-touch-startup-image" media="(device-width: 320px) and (device-height: 480px) and (-webkit-device-pixel-ratio: 1)" href="/content/img/startup320x480.png" />' + nl +
